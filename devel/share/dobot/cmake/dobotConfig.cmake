...
if("TRUE" STREQUAL "TRUE")
  set(dobot_SOURCE_PREFIX /home/cangorur/Workspace/chariot/conveyor_simulation_guthub/src/dobot)
  set(dobot_DEVEL_PREFIX /home/cangorur/Workspace/chariot/conveyor_simulation_guthub/devel)
  set(dobot_INSTALL_PREFIX "")
  set(dobot_PREFIX ${dobot_DEVEL_PREFIX})
else()
  set(dobot_SOURCE_PREFIX "")
  set(dobot_DEVEL_PREFIX "")
  set(dobot_INSTALL_PREFIX /home/cangorur/Workspace/chariot/conveyor_simulation_guthub/install)
...
if(NOT "/home/cangorur/Workspace/chariot/conveyor_simulation_guthub/devel/include;/home/cangorur/Workspace/chariot/conveyor_simulation_guthub/src/dobot/include " STREQUAL " ")
  set(dobot_INCLUDE_DIRS "")
  set(_include_dirs "/home/cangorur/Workspace/chariot/conveyor_simulation_guthub/devel/include;/home/cangorur/Workspace/chariot/conveyor_simulation_guthub/src/dobot/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Xin Yu <Xin.Yu@gt-arc.com>, Luke <liuzhufu@dobot.cc>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cangorur/Workspace/chariot/conveyor_simulation_guthub/src/dobot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cangorur/Workspace/chariot/conveyor_simulation_guthub/devel/lib;/home/cangorur/Workspace/auto_warehousing_paperCode/devel/lib;/opt/ros/kinetic/lib)
