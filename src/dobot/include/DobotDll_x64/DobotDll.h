...
// Modified 15 Feb: begin
extern "C" DOBOTDLLSHARED_EXPORT int SetColorSensor(bool enable, uint8_t colorPort);
extern "C" DOBOTDLLSHARED_EXPORT int GetColorSensor(uint8_t *r, uint8_t *g, uint8_t *b);
extern "C" DOBOTDLLSHARED_EXPORT int SetInfraredSensor(bool enable, uint8_t infraredPort);
extern "C" DOBOTDLLSHARED_EXPORT int GetInfraredSensor(uint8_t infraredPort, uint8_t *value);
// Modified 15 Feb: end
