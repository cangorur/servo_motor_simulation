...
#include "string.h"
static void ex_rweYrcVwoyC1CNGIlXOiH_(PMValue out,ConstPMValue in,const
boolean_T ex_1YXwEl8_6cUeYGB_i0l0p2,const boolean_T ex_Qmu676yE9oxL758xSv1lO1)
;static void ex_yHfj6furiKagbUS6IlLsO_(PMValue out,ConstPMValue in);void
tlu2_1d_linear_nearest_process(PMValue out,ConstPMValue in){
ex_yHfj6furiKagbUS6IlLsO_(out,in);}void tlu2_1d_linear_linear_process(PMValue
out,ConstPMValue in){ex_yHfj6furiKagbUS6IlLsO_(out,in);}static void
ex_yHfj6furiKagbUS6IlLsO_(PMValue out,ConstPMValue in){const real_T *
ex_o4vEMLK0HyE2rpCeHx1ax2=(const real_T *)((const void *const *)in)[0];const
real_T *ex_Uls_Qya8OT6MAYc5Y2sHL0=(const real_T *)((const void *const *)in)[1]
;const size_t n= *((const size_t *)((const void *const *)in)[2]);real_T *x=(
real_T *)((void **)out)[0];real_T *ex_VxxeDNxb3XYZvQXh_7Mga_=(real_T *)((void *
*)out)[1];real_T *ex_nG9lEleqRQ___s_o0rpbM2=(real_T *)((void **)out)[2];memcpy
(x,ex_o4vEMLK0HyE2rpCeHx1ax2,n *sizeof(real_T));memcpy(
ex_VxxeDNxb3XYZvQXh_7Mga_,ex_Uls_Qya8OT6MAYc5Y2sHL0,n *sizeof(real_T));
ex_kxquG9pkEjt4fXtMQOsqG2(x,ex_VxxeDNxb3XYZvQXh_7Mga_,n);
ex_nG9lEleqRQ___s_o0rpbM2[0]= x[0];ex_nG9lEleqRQ___s_o0rpbM2[1]= x[n -1];}void
tlu2_1d_linear_nearest_value(PMValue out,ConstPMValue in){
ex_rweYrcVwoyC1CNGIlXOiH_(out,in,false,false);}void tlu2_1d_linear_linear_value
(PMValue out,ConstPMValue in){ex_rweYrcVwoyC1CNGIlXOiH_(out,in,true,false);}
void tlu2_1d_linear_nearest_derivatives(PMValue out,ConstPMValue in){
ex_rweYrcVwoyC1CNGIlXOiH_(out,in,false,true);}void
tlu2_1d_linear_linear_derivatives(PMValue out,ConstPMValue in){
ex_rweYrcVwoyC1CNGIlXOiH_(out,in,true,true);}static void
...
ex_Tm5e8nZqqU9KpHRYeiRYn2[0]= 0.0;}else if(ex_VxxeDNxb3XYZvQXh_7Mga_[
ex_zqRxlQY_R2aAe0l80GR7z1]==ex_VxxeDNxb3XYZvQXh_7Mga_[
ex_zqRxlQY_R2aAe0l80GR7z1 +1]){ex_Tm5e8nZqqU9KpHRYeiRYn2[0]= 0.0;}else{
ex_Tm5e8nZqqU9KpHRYeiRYn2[0]= ex_VxxeDNxb3XYZvQXh_7Mga_[
ex_zqRxlQY_R2aAe0l80GR7z1]*ex_5LnJCGYiDv_7y1GYvBMv60[0]+
ex_VxxeDNxb3XYZvQXh_7Mga_[ex_zqRxlQY_R2aAe0l80GR7z1 +1]*
ex_5LnJCGYiDv_7y1GYvBMv60[1];}}else{if(ex_yt2Bobcuk9gODDeT4FtSI0<2){
ex_Tm5e8nZqqU9KpHRYeiRYn2[0]= ex_VxxeDNxb3XYZvQXh_7Mga_[0];}else if(
ex_VxxeDNxb3XYZvQXh_7Mga_[ex_zqRxlQY_R2aAe0l80GR7z1]==
ex_VxxeDNxb3XYZvQXh_7Mga_[ex_zqRxlQY_R2aAe0l80GR7z1 +1]){
ex_Tm5e8nZqqU9KpHRYeiRYn2[0]= ex_VxxeDNxb3XYZvQXh_7Mga_[
ex_zqRxlQY_R2aAe0l80GR7z1];}else{ex_Tm5e8nZqqU9KpHRYeiRYn2[0]=
ex_VxxeDNxb3XYZvQXh_7Mga_[ex_zqRxlQY_R2aAe0l80GR7z1]*ex_tUzVGBAzf2uDE1xeON4Gc1
