  ...
  const NeDynamicSystemInput *t4, NeDsMethodOutput *t5)
{
  ...
  out.mX[28] = Loop_Subsystem_MotorControlSubsystem_DC_Motor_La_i *
    -0.006488870651066;
  out.mX[29] = X_idx_6;
  out.mX[30] = X_idx_6 * 154.11002218632896;
  out.mX[31] = 0.0;
  out.mX[32] = X_idx_1 * 258.5;
  out.mX[33] = ((((X_idx_0 * 0.006488870651066 + X_idx_4 *
  ...
  out.mX[75] = Loop_Subsystem_MotorControlSubsystem_Sensor_Torque_Sensor_T;
  out.mX[76] = 0.0;
  out.mX[77] = 0.0;
  out.mX[78] = X_idx_1;
  out.mX[79] = U_idx_3;
  ...
  out.mX[85] = U_idx_1;
  out.mX[86] = -U_idx_1;
  out.mX[87] = Loop_Subsystem_MotorControlSubsystem_Torque_Source_w;
  out.mX[88] = 0.0;
  out.mX[89] = X_idx_1;
  out.mX[90] = U_idx_2;
  out.mX[91] = -U_idx_2;
  out.mX[92] = Loop_Subsystem_MotorControlSubsystem_Torque_Source_w;
  (void)ds;
  (void)t5;
  return 0;
}
