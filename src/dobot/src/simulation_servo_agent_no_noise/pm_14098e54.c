...
pm_KOiiP_gqHP9q_8e9O2OJi2=(pm_xELwgkvowKyM9polnZA8_2 *)((
pm_an0wiQTjdlKE72zC6FJ0a2)->mCallocFcn((pm_an0wiQTjdlKE72zC6FJ0a2),(sizeof(
pm_xELwgkvowKyM9polnZA8_2)),(1)));pm_KOiiP_gqHP9q_8e9O2OJi2->mNumRow=
pm_VJaXi2SoIcIed2aDCbUEF2;pm_KOiiP_gqHP9q_8e9O2OJi2->mNumCol=
pm_Hje8CN1dduWhywTP07JA01;pm_KOiiP_gqHP9q_8e9O2OJi2->mX=((
pm_an0wiQTjdlKE72zC6FJ0a2)->mCallocFcn((pm_an0wiQTjdlKE72zC6FJ0a2),(
pm_VJaXi2SoIcIed2aDCbUEF2 *pm_Hje8CN1dduWhywTP07JA01),(sizeof(real_T))));
return pm_KOiiP_gqHP9q_8e9O2OJi2;}pm_xELwgkvowKyM9polnZA8_2 *
pm_kXYSn24Zby7CBHFJTWVAL_(const pm_xELwgkvowKyM9polnZA8_2 *
pm_B0LNpsKPbGgqFDFZWKsdG_,PmAllocator *pm_an0wiQTjdlKE72zC6FJ0a2){
pm_xELwgkvowKyM9polnZA8_2 *pm_cPpFNNxfnE9grx4hesF5K_= pm_nz2UGYq4cnG1apCgKensi1
(pm_B0LNpsKPbGgqFDFZWKsdG_->mNumRow,pm_B0LNpsKPbGgqFDFZWKsdG_->mNumCol,
pm_an0wiQTjdlKE72zC6FJ0a2);pm_RBkGG4mV2eXeUxWqZrZ_D0(pm_cPpFNNxfnE9grx4hesF5K_
,pm_B0LNpsKPbGgqFDFZWKsdG_);return pm_cPpFNNxfnE9grx4hesF5K_;}void
...
= pm_EphGIaq4DHWXGRbDOrH9x_->mNumRow;size_t n= pm_EphGIaq4DHWXGRbDOrH9x_->
mNumCol;size_t pm_OUB2pptsvtdGL_LyqpgOa0= 0;int32_T pm_QQvrlcFdHDI1GGuBZrW5C2=
0;int32_T *pm_S51jjFL079S8kdC86krPC0= pm_EphGIaq4DHWXGRbDOrH9x_->mJc;int32_T *
...
const pm_xELwgkvowKyM9polnZA8_2 *src){size_t n= dst->mNumRow *dst->mNumCol;;;
if(n>0&&dst->mX!=src->mX){memcpy(dst->mX,src->mX,n *sizeof(real_T));}}
boolean_T pm_Ct3OT7r9ARKw_pJqHPLDS2(const pm_xELwgkvowKyM9polnZA8_2 *dst,const
