...
int32_T simulation_servo_agent_9c2ac8b8_1_ds_log(const NeDynamicSystem *ds,
  const NeDynamicSystemInput *t4, NeDsMethodOutput *t5)
{
  ...
  out.mX[10] = X_idx_4;
  out.mX[11] = X_idx_1;
  out.mX[12] = Loop_Subsystem_MotorControlSubsystem_DC_Motor_La_i;
  out.mX[13] = X_idx_0;
  out.mX[14] = X_idx_5;
  ...
  out.mX[26] = Loop_Subsystem_MotorControlSubsystem_DC_Motor_La_i *
    -0.006488870651066;
  out.mX[27] = X_idx_5;
  out.mX[28] = X_idx_5 * 154.11002218632896;
  out.mX[29] = 0.0;
  out.mX[30] = X_idx_1 * 258.5;
  out.mX[31] = (((X_idx_0 * 0.006488870651066 + X_idx_4 * -0.0038684719535783366)
  ...
  out.mX[61] = X_idx_1;
  out.mX[62] = X_idx_1;
  out.mX[63] = Loop_Subsystem_MotorControlSubsystem_Sensor_Torque_Sensor_T;
  ...
  out.mX[68] = U_idx_1;
  out.mX[69] = -U_idx_1;
  out.mX[70] = Loop_Subsystem_MotorControlSubsystem_Torque_Source_w;
  out.mX[71] = 0.0;
  out.mX[72] = X_idx_1;
  out.mX[73] = U_idx_2;
  out.mX[74] = -U_idx_2;
  out.mX[75] = Loop_Subsystem_MotorControlSubsystem_Torque_Source_w;
  (void)ds;
  (void)t5;
  return 0;
}
